...
export function insert(seakEvent, replaceIfExists, noOverwrite) {
...
export function select({
  ...
  favorited = "*",
    ...
    const result = []
    const namedFilteredEvents = name === '*' ? database.events : find('name', name)
...
function find(property, value, eventObject = null) {
